VERSION 5.00
Begin VB.Form frmSubstitution3 
   Caption         =   "Kingdom of Knowledge"
   ClientHeight    =   7200
   ClientLeft      =   -1545
   ClientTop       =   6525
   ClientWidth     =   11955
   Icon            =   "frmSubstitution3.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmSubstitution3.frx":424A
   ScaleHeight     =   7200
   ScaleWidth      =   11955
   ...
   Begin VB.CommandButton cmdhelp 
      Height          =   855
      Left            =   9720
      Picture         =   "frmSubstitution3.frx":F0C5
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   5880
      Width           =   1575
   ...
   Begin VB.CommandButton cmdSubmit 
      Height          =   1335
      Left            =   4920
      Picture         =   "frmSubstitution3.frx":1382A
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   5040
      Width           =   2175
   ...
   Begin VB.Label lblQuestion 
      ...
      Caption         =   "Find the point of intersection of the lines 3x - 2y = 12 and 2y - x = 12"
      BeginProperty Font 
   ...
   End
End
Attribute VB_Name = "frmSubstitution3"
...
'The last of three consecutive questions on the lesson about the method of substitution.
Option Explicit
...
Private Sub cmdSubmit_Click()
    ...
    Else
        ...
        If optA.Value = True And frmRoles.intMultiply > 1 Then
            ...
            MsgBox "Correct, you must first rearrange the equations, and then substitute." _
        ...
        ElseIf optA.Value = False And frmRoles.intBlock > 1 Then
            ...
            MsgBox "Incorrect, you must first rearrange the equations, and then substitute." _
